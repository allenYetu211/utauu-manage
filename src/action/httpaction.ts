...
export const getArticleAll = async () => {
	return await HTTP_CLIENT.get({ url: 'u/v/admin/getArticle' });
};

// 获取分类标签
export const getTagClassArticle = (tag: string) => {
	return HTTP_CLIENT.get({
		url: 'u/v/admin/getTagClassArticle',
		params: {
			tags: tag,
		},
	});
...
export const getPublishClassArticle = () => {
	return HTTP_CLIENT.get({
		url: 'u/v/admin/getPublishArticle',
	});
};

// 获取文章详情
export const getArticleDetail = (id: number) => {
	return HTTP_CLIENT.get({ url: `u/v/admin/getArticleDetail/${id}` });
};

// 获取全部标签
export const getTagsAll = () => {
	const result = HTTP_CLIENT.get({ url: 'u/v/admin/getTagAll' });
...
export const postCreateArticle = (data: ICreateArticle) => {
	return HTTP_CLIENT.post({ url: 'u/v/admin/createArticle', data });
};

// 新建标签
export const postCreateTag = async (data: ICreateTag) => {
	await HTTP_CLIENT.post({ url: 'u/v/admin/createTag', data });
};

// 删除标签
export const deleteTag = async (_id: number) => {
	await HTTP_CLIENT.delete({
		url: 'u/v/admin/deleteTag',
		params: {
			tagID: _id,
		},
	});
